<?php
/*
 * Template Name: Services Page with Header
 *
 * Content placed in blocks area appears above sidebar
 */
...
<div class="main about-page">
   ...
   <section class="review-section services-sec">
      <div class="container">
        ...
        <!-- shows above sidebar, below banner -->
          ...
          <section class="banner">
            <div class="row">
              ...
              while ( have_posts() ) :
                ...
                get_template_part( 'template-parts/content-page-notitle', get_post_type() );
