...
<section class="contactus-section footer-cnt-frm photo" style="background-image: url('<?php echo get_field('cta_background_image'); ?>');">
  <div class="row">
    <div class="col-md-4 offset-md-2 pt-md-5 pb-md-5">
      <div class="contactus">
